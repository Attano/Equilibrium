...
public Plugin:myinfo =
{
    ...
    author      = "Visor",
    version     = "1.1",
    description = "Tank's screen fades red when taking damage",
	url 		= "http://steamcommunity.com/id/Marauder_Shields/"
};
...
{
	if (!attacker || weapon < 1 || !IsTank(victim)) return Plugin_Continue;
